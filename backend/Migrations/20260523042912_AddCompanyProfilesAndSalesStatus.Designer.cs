...
namespace backend.Migrations
{
    ...
    [Migration("20260523042912_AddCompanyProfilesAndSalesStatus")]
    partial class AddCompanyProfilesAndSalesStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Domain.Entities.AppSumoCategory", b =>
                {
                    ...
                    b.ToTable("AppSumoCategories");
                });

            modelBuilder.Entity("backend.Domain.Entities.AppSumoProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppSumoProducts");
                });

            modelBuilder.Entity("backend.Domain.Entities.AppSumoReview", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("AppSumoReviewId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasIndex("TacoRating");

                    b.HasIndex("ProductId", "AppSumoReviewId")
                        .IsUnique()
                        .HasFilter("\"AppSumoReviewId\" IS NOT NULL");

                    b.ToTable("AppSumoReviews");
                });

            modelBuilder.Entity("backend.Domain.Entities.AppSumoScrapeRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("backend.Domain.Entities.ProductScrapeState", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("backend.Domain.Entities.ProductSuggestion", b =>
                {
                    ...
                    b.Property<double>("AvgDirectClientRatio")
                        .HasColumnType("double precision");
                    ...
                    b.Property<string>("ClusterIdsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("[]");
            ...
            modelBuilder.Entity("backend.Domain.Entities.AppSumoProduct", b =>
                {
                    b.HasOne("backend.Domain.Entities.AppSumoCategory", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("backend.Domain.Entities.AppSumoReview", b =>
                {
                    b.HasOne("backend.Domain.Entities.AppSumoProduct", "Product")
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("backend.Domain.Entities.ProductScrapeState", b =>
                {
                    b.HasOne("backend.Domain.Entities.AppSumoScrapeRun", "LastRun")
                        .WithMany()
                    ...
                    b.HasOne("backend.Domain.Entities.AppSumoProduct", "Product")
                        .WithOne("ScrapeState")
                        .HasForeignKey("backend.Domain.Entities.ProductScrapeState", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
