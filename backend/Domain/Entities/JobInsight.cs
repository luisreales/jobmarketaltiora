...
public class JobInsight
{
    ...
    // --- Semantic Clustering (Fase 3) ---

    /// <summary>
    /// JSON-serialized float[] embedding of MainPainPoint + PainCategory + SuggestedSolution.
    /// Generated by SemanticClusterEngine. Null until embedding has been generated.
    /// </summary>
    public string? EmbeddingVectorJson { get; set; }

    /// <summary>UTC timestamp when the embedding was last generated.</summary>
